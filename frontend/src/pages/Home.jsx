...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const tick = (currentTime) => {
      ...
      setAnimatedStats(stats.map((stat) => Math.floor(stat.value * progress)));
      ...
      <section className="home-cards-section">
        <div className="container">
          ...
          <div className="cards-grid">
            {cards.map((card, i) =>
              card.external ? (
                <a key={card.title} href={card.href} className="card" style={{ "--card-index": i }}>
                ...
                <Link key={card.title} to={card.href} className="card" style={{ "--card-index": i }}>
                  <div className="card-logo-wrap">
                    <img src={card.logo} alt={card.alt} className="card-logo" />
                  </div>
